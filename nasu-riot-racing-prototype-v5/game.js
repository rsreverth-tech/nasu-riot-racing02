(() => {
  ...
  const moods = {
    ...
    happy: { src: './assets/driver/president-happy-v3.png', label: 'EAT DUST!' },
    angry: { src: './assets/driver/president-angry-v3.png', label: 'YOU PUNK!' }
  };
  ...
  function triggerJump(fromRamp = true) {
    state.jump = fromRamp ? state.jumpDuration : state.jumpDuration * .72;
